...
faqs_data = [
    ...
    {'question': 'What Technologies Do You Work With?',                   'answer': 'Python/Django, React, Node.js, Flutter, React Native, PostgreSQL, AWS, and more — chosen based on your project requirements.',                             'order': 5},
